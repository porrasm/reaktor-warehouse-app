...
var baseURL = "https://bad-api-assignment.reaktor.com/v2/availability/";
router.get('/:manufacturer', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var path, data, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                path = baseURL + req.params.manufacturer;
